        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <figure class="image-block">
                    <img src="{{ asset('frontend_assets/images') }}/portfolio-block.jpg" alt="">
                </figure>
                ...
                <div class="description">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Autem porro ex repellat nobis
                        ...
                        ipsam.</p>
                    <ul class="gallery">
                        <li><img src="{{ asset('frontend_assets/images') }}/gallery-1.jpg" alt="" class="img-fluid w-100"></li>
                        <li><img src="{{ asset('frontend_assets/images') }}/gallery-2.jpg" alt="" class="img-fluid w-100"></li>
                    </ul>
                    <h3>Process Story</h3>
